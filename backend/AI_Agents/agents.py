...
try:
    ...
    # Fallback if arch package or other dependencies are missing
    try:
        from ML_Models.Regime_Classificaiton import Regime_Classifier
        VOLATILITY_AVAILABLE = False
        print(f"Warning: Volatility_Forecasting not available: {e}")
    except ImportError:
        ...
        try:
            ...
            from ML_Models.Regime_Classificaiton import Regime_Classifier
            VOLATILITY_AVAILABLE = False
            print("Warning: Volatility_Forecasting not available - agents will use fallback")

# Import base classes
from AI_Agents.base_agent import BaseAgent, AgentResponse
